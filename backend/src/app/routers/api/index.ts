...
import { AUTH_BASE_API_PATH, authenticateRequest, CHANNELS_BASE_API_PATH, USERS_BASE_API_PATH } from '../../../modules';
import { Environment } from '../../../utils';

export function ApiRouter (authRouter: Router, usersRouter: Router, channelsRouter: Router): Router {
  const router = Router();
